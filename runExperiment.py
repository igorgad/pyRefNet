...
trainParams.datasetfile = '/media/pepeu/582D8A263EED4072/DATASETS/MedleyDB/REFTEST_N' + str(model.N) + '_NW' + str(model.nwin) + '_XPAN40_medleyVBRdataset.mmap'
trainParams.log_root     = '/media/pepeu/582D8A263EED4072/DATASETS/MedleyDB/tensorlogs/'

trainParams.runName      = "{}_N{}_NW{}".format('initTest', model.N, model.nwin)
